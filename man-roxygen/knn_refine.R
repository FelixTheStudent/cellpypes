...
#' apply.
#' In other words, marker gene UMI counts in the cell's neighborhood all have to 
...
#' 
#' It is reasonable to assume a unassigned cell is of the same cell type as the
#' majority of its nearest neighbors.
#' Therefore, cellpypes implements a kNN classifier to refine the labels from
