...
#' @param return_logical_matrix logical. If TRUE, a logical matrix with
#' classes in columns and cells in rows is returned instead of a 
#' factor with cell type labels.
