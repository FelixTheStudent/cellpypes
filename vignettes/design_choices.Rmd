...
Cellpype objects have these slots:
  ...
  * **classes**: df with columns: class, parent.
    Most recent class is first row in data.frame.
  * **rules**: df with columns: class, feature, operator, threshold
    Most recent rule is first row in data.frame.
  * **.data**
    * original_object
...
library(testthat)   # develop unit tests requires testthat::test_that and obj_min
