...
```{r quickstart, eval=FALSE, include=TRUE}
library(tidyverse)
library(cellpypes)
seurat_object %>%
  pype_from_seurat() %>%
...
[this tutorial](https://satijalab.org/seurat/articles/pbmc3k_tutorial.html),
```{r class_to_deseq2}
...
The crucial command is `pseudobulk(counts, pseudobulk_id(meta_df))`,
